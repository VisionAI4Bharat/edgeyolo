#ifndef EDGEYOLO_BRIDGE_H
#define EDGEYOLO_BRIDGE_H
...
namespace detect {
    ...
    inline void static_resize(cv::Mat& img, cv::Size input_size, resizeInfo& _info) {
    ...
    inline resizeInfo resizeAndPad(cv::Mat &src_img, cv::Size _size, bool center=false, bool show=false)
    {
    ...
    inline cv::Mat draw_boxes(cv::Mat image,
